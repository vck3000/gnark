...
func BenchmarkSetup(b *testing.B) {
	...
	b.Run("setup", func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			bn254groth16.Setup(ccs.(*cs.R1CS), &pk, &vk)
		}
	})
}
...
func BenchmarkProver(b *testing.B) {
	...
	var pk bn254groth16.ProvingKey
	bn254groth16.DummySetup(ccs.(*cs.R1CS), &pk)

	b.ResetTimer()
	b.Run("prover", func(b *testing.B) {
		for i := 0; i < b.N; i++ {
			_, _ = bn254groth16.Prove(ccs.(*cs.R1CS), &pk, fullWitness, backend.ProverOption{})
		}
	})
}
...
func BenchmarkVerifier(b *testing.B) {
	...
	var vk bn254groth16.VerifyingKey
	bn254groth16.Setup(ccs.(*cs.R1CS), &pk, &vk)
	proof, err := bn254groth16.Prove(ccs.(*cs.R1CS), &pk, fullWitness, backend.ProverOption{})
	if err != nil {
		panic(err)
	}
